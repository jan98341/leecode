...
public class Title17 {
    ...
    public static void main(String[] args) {
        System.out.println("case1结果：" + letterCombinations("23"));
        System.out.println("case2结果：" + letterCombinations(""));
        System.out.println("case3结果：" + letterCombinations("2"));
        System.out.println("case43结果：" + letterCombinations("456"));
    }
